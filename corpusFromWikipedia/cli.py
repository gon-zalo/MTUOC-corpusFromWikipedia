...
# SEGMENT SUBPARSER
    ...
    segment_parser.add_argument("--force-srx-lang", help="Override the default SRX language configuration if your language is not available in the file. Yoy may use one of the following: Default, Generic, ByLineBreak or ByTwoLineBreaks. If you are segmenting a parallel corpus, provide lang=segmenter pairs, e.g. et=generic", nargs="*", default=[], required=False)
